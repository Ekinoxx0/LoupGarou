...
public class RVoleur extends Role {
	...
	public String getDescription() {
		return "Ton objectif sera celui de ta nouvelle carte. Chaque nuit, tu pourras choisir un joueur avec lequel tu échangeras ta carte. Il deviendra "
				+ getName()
				+ "§f à son tour. Mais si le village décide d'éliminer un §a§lVillageois§f, tu auras trop peur pour voler la nuit suivante.";
	}
	...
	public void onNightTurn(LGPlayer player, Runnable callback) {
		...
		player.choose(choosen -> {
			if (choosen != null) {
				...
				choosen.sendMessage(
						"§cTu t'es fais volé ta carte pendant la nuit. Tu es maintenant " + getName() + "§6.");
